...
const vector<pair<string, string>> cueCards = {
    ...
    {"Why do covalent compounds have lower melting points than ionic compounds?", "Melting ionic compounds invlves breaking the ionic bond, which requires a lot of energy\nMelting covalent compounds only requires breaking intermolecular forces, which are much weaker"}
};
